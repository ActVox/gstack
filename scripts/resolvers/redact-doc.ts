...
# macOS mktemp ignores TMPDIR when no template is supplied. Use an explicit,
# portable template so the pending MEDIUM file stays in the configured temp root.
