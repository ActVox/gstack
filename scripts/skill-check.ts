...
import { discoverTemplates, discoverSkillFiles, isSkillGeneratedForHost } from './discover-skills';
...
for (const { tmpl, output } of TEMPLATES) {
  ...
  if (!isSkillGeneratedForHost(skillDir, CLAUDE_GENERATION)) continue;
